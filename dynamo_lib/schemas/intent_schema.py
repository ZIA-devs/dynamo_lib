...
class IntentSchema(BaseModel):
    ...
    start_reengagement: bool = Field(default=False, alias='start_reengagement', description='Whether the intent entry starts a re-engagement')
    stop_reengagement: bool = Field(default=False, alias='stop_reengagement', description='Whether the intent entry ends a re-engagement')
