...
url: str = os.environ.get("SUPABASE_URL", "https://rmxzkmabroiflzruktla.supabase.co")
key: str = os.environ.get("SUPABASE_KEY", "sb_secret_64sYKzKiu_4o5xH-EDfT0A_Asdls7dO")
